...
public class ProductCheckoutTest extends TestBase {
	...
	public void setup() {
		searchResultPage = homePage.goToLoginPage().doLoginWith("jiveh30363@numerobo.com", "Password")
	...
	public void checkoutTest() {
		String result =
			searchResultPage.clickOnTheProductAtIndex(0).changeSize(L).addProductToCart()
